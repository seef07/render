...
data_path = "\Users\saif-\OneDrive\Bureaublad\Project\options.png" 		#path to data directory
png_path = "\Users\saif-\OneDrive\Bureaublad\Project\options1.png" 			#path to png directory
